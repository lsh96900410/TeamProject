...
<%@page import="myProtein.board.util.PageMaker" %>
<%@page import="myProtein.board.BoardListPageMakerDto"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page import="myProtein.board.Board"%>
<%@page import="myProtein.board.BoardService"%>
<%@page import="myProtein.board.PageInputDto" %>
...
BoardListPageMakerDto boardListPage =boardService.findBoardList(Integer.parseInt(pageno));
							...
							<form name="f" method="post" action="">
								<table border="0" cellpadding="0" cellspacing="1" width="590"
									...
									<tr>
										...
										<td width=70 align=center bgcolor="ffffff" align="left"><%=board.getRead_count()%>
										</td>
									</tr>
									<!-- 
									<tr>
