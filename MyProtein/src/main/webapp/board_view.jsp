							...
							<table width=590 border=0 cellpadding=0 cellspacing=0>
								<tr>
									<td align=center>
										...
										<%if(sUser!=null && sUser.getU_id().equals(board.getU_id())){ %>
										...
										<%}else if(sUser!=null && !sUser.getU_id().equals(board.getU_id())){ %>
										<input type="button" value="글쓰기" onClick="boardCreate()"> &nbsp; 
										<input type="button" value="답글쓰기" onClick="boardReplyCreate()"> &nbsp; 
										<input type="button" value="수정" onClick="writer_check()"> &nbsp; 
										<input type="button" value="삭제" onClick="writer_check()"> &nbsp; 
										<%}else if(sUser==null || sUser.getU_id().equals("")){ %>
										<input type="button" value="글쓰기" onClick="login_message()"> &nbsp; 
										<input type="button" value="답글쓰기" onClick="login_message()"> &nbsp; 
										<input type="button" value="수정" onClick="login_message()"> &nbsp; 
										<input type="button" value="삭제" onClick="login_message()"> &nbsp; 
										<%} %>
